...
namespace UI
{
    namespace GameplayUI
    {
        ...
        {
            menu_button->initialize("Menu Button", Config::menu_button_large_texture_path, menu_button_width, menu_button_height, sf::Vector2f(menu_button_x_position, menu_button_y_position));
        ...
        {
            search_type_text->initialize("Search Type  :  Linear Search", sf::Vector2f(search_type_text_x_position, text_y_position1), FontType::BUBBLE_BOBBLE, font_size);
            number_of_comparisons_text->initialize("Comparisons  :  0", sf::Vector2f(comparisons_text_x_position, text_y_position1), FontType::BUBBLE_BOBBLE, font_size);
            number_of_array_access_text->initialize("Array Access  :  0", sf::Vector2f(array_access_text_x_position, text_y_position1), FontType::BUBBLE_BOBBLE, font_size);

            num_sticks_text->initialize("Number of Sticks  :  0", sf::Vector2f(num_sticks_text_x_position, text_y_position2), FontType::BUBBLE_BOBBLE, font_size);

            delay_text->initialize("Delay  :  0 ms", sf::Vector2f(delay_text_x_position, text_y_position2), FontType::BUBBLE_BOBBLE, font_size);

            time_complexity_text->initialize("Time Complexity  :  O(n)", sf::Vector2f(time_complexity_text_x_position, text_y_position2), FontType::BUBBLE_BOBBLE, font_size);
        }
